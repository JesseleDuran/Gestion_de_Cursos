 ...
 * @author Mota
 */
public class CursoUpdateView extends javax.swing.JFrame {

    /**
     * Creates new form CursoUpdateView
     */
    public CursoUpdateView( MySQLdbConnection db, LinkedHashMap<String, Object> curso) {
        super("Actualizar Curso");
        this.db = db;  
        this.curso = curso;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Actualizar Curso");
    ...
    private void aceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButtonActionPerformed
        ...
        try
        {
            if(validaciones() != true)
            {
                ...
                if(controller.edit(map, db, (Integer) curso.get("1")) == true)
                {
                    dispose();
                    JOptionPane.showMessageDialog(null, "El curso se ha actualizado correctamente", "Registro con éxito", JOptionPane.INFORMATION_MESSAGE);
                }
                else
                {
    ...
    private LinkedHashMap<String, Object> curso;
    
    private void initJtext()
    {

        tituloField.setText((String) curso.get("2"));
        topeField.setText(Long.toString((long) curso.get("3")));

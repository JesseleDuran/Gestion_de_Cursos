...
public class HorarioUpdateView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HorarioUpdateView
     */
    public HorarioUpdateView(MySQLdbConnection db, LinkedHashMap<String, Object> horario) {
        super("Actualizar Horario");
        this.db = db;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Actualizar Horario");
    ...
    private LinkedHashMap<String, Object> horario;
    ...
    private void initJtext()
    {
        ...
        inicioJSpinner.setValue(horario.get("2"));
        finalJSpinner.setValue(horario.get("3"));
